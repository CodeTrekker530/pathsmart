      ...
      <View style={styles.sidebar}>
        <View style={styles.sidebarIcons}>
          <Image
            ...
            style={[styles.sidebarIcon, { tintColor: undefined }]}
          />
          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardContent}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  router.push("/modules/storeManagement/screens/ManageBusiness")
                }
              >
              ...
              <>
                ...
                <View style={styles.accountModalContent}>
                  <View style={styles.accountModalRow}>
                    ...
                    <Text style={styles.accountModalValue}>
                      Joseph Frondozo Martin
                    </Text>
                  </View>
                  <TouchableOpacity
